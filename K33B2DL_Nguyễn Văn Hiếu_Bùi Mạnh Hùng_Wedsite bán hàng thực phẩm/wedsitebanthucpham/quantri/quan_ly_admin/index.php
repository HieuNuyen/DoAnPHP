        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="https://avi.edu.vn/wp-content/uploads/2019/11/london-2393098.jpg" alt="User Image" width="40" height="40">
              <?php echo $_SESSION['tendnadmin'];?>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="https://avi.edu.vn/wp-content/uploads/2019/11/london-2393098.jpg" alt="User Image">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../quantri/logout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
...
?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2017-2017 <a href="#">Food</a>.</strong> All rights
    reserved.
  </footer>
